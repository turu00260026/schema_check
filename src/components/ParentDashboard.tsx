...
function generateAdvice(
  ...
  // 全ステップ70〜79%（中間帯：どの条件にも引っかからない場合）
  if (advice.length === 0) {
    advice.push({
      title: '📈 3つのステップともバランスよく取り組めています',
      why: 'じょうきょうかくにん・ずをえらぶ・しきをえらぶのすべてで70%前後の正答率です。大きな苦手はありませんが、どのステップもまだ伸びしろがある段階です。',
      tips: [
        '間違えた問題の「どのステップでミスしたか」を一緒に確認してみましょう。パターンが見えてくると次の練習が絞りやすくなります。',
        '特に「逆から考える問題（はじめにいくつあったか）」や「比べる問題」は難しいので、そのタイプを意識して繰り返すと効果的です。',
        '正解した問題でも「なぜこの式にしたの？」と理由を説明させてみましょう。説明できると理解が一段深まります。',
      ],
    });
  }
  return advice;
